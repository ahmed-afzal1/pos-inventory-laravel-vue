        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><router-link to="/employee">Supplier</router-link></li>
                ...
                <table class="table table-striped" v-else>
                  ...
                  <tbody>
                    ...
                    <tr v-for="supplier in paginatedSuppliers" :key="supplier.id">
                        <td>{{supplier.name}}</td>
                        <td> <img :src="supplier.photo" alt="" height="60" width="60"> </td>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form @submit.prevent="createSupplier" id="supplierForm">
            <div class="modal-body">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Enter Phone" min="1" v-model="form.phone">
                </div>

                <span class="text-danger mb-2" v-if="errors.shopname">{{errors.shopname[0]}}</span>
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Shopname" v-model="form.shopname">
                </div>
        ...
        loadSupplier(){
          ...
          axios.get('/api/supplier')
            .then(res=>{
               ...
               this.pagination.totalPage = this.suppliers.length / this.pagination.rowPerPage
               this.paginatedSuppliers = this.suppliers.slice(0, this.pagination.rowPerPage);
          ...
          clickCallback: function(page) {
            ...
            this.paginatedSuppliers = this.suppliers.slice(skip, skip+this.pagination.rowPerPage);
          },
