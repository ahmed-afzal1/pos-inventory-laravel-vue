        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">All Tax</li>
            </ol>
          </div>
        </div>
      </div>
              ...
              <div class="card-body p-0">
                ...
                <table class="table table-striped" v-else>
                  ...
                  <tbody>
                    ...
                    <tr v-for="tax in taxs" :key="tax.id">
                      <td>{{tax.id}}</td>
                      <td>{{tax.name}}</td>
                      <td>{{tax.rate}}%</td>
                      <td>
                        <router-link :to="{name: 'editTax', params: {id: tax.id}}" class="btn btn-sm btn-info">Edit</router-link>
                        <a @click="deleteTax(tax.id)" class="btn btn-sm btn-danger">
                            Delete
                        </a>
                      </td>
...
<div class="modal fade" id="taxModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <form @submit.prevent="createTax" id="taxForm">
